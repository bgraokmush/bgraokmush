...
###
I'm a passionate Software Engineer specializing in **Next.js**, **Rust**, **.NET Core**, and **Solana smart contracts**. My journey in web and blockchain development is backed by solid project experiences and a keen interest in cutting-edge technologies.

### Skills and Expertise:
- Proficient in **Next.js** and **TailwindCSS**, crafting intuitive and responsive UIs.
- Deep understanding of **.NET Core** for backend solutions.
- Advanced in **Rust native** and **Anchor**, actively developing smart contracts on the Solana blockchain.
  
### Featured Projects:
- **Sol-PR**: A growing hackathon project, focused on managing GitHub PR approvals with bounties in SOL tokens. Submitted to the 2024 Radar Solana Hackathon.
...
- **Turbine3 Builder**: This repository contains Rust code samples written while learning at the Turbin3 Solana Builders Cohort
  [Cohort Repo](https://github.com/solana-turbin3/q1-25-builder-bgraokmush)
